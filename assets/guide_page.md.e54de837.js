import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.6ffded5f.js";const u=JSON.parse('{"title":"页面配置","description":"","frontmatter":{},"headers":[],"relativePath":"guide/page.md","filePath":"guide/page.md","lastUpdated":1727427281000}'),p={name:"guide/page.md"},o=l(`<h1 id="页面配置" tabindex="-1">页面配置 <a class="header-anchor" href="#页面配置" aria-label="Permalink to &quot;页面配置&quot;">​</a></h1><p>本主题默认支持并使用以下页面类型。</p><h2 id="frontmatter" tabindex="-1">Frontmatter <a class="header-anchor" href="#frontmatter" aria-label="Permalink to &quot;Frontmatter&quot;">​</a></h2><p>在 <code>md</code> 文件中除了 vitepress 默认可使用字段以外，主题新增了一些可使用配置。</p><ul><li><code>date</code>：文章时间</li><li><code>sticky</code>：首页排序值，值越大越靠前。</li><li><code>banner</code>：文章页横幅背景，参考全局横幅配置。</li><li><code>cover</code>：文章封面图，可为字符串或数组或对象，如果数组长度为 2 则会根据主题自动切换。</li><li><code>singleColumn</code>：单栏显示详情页，为 true 时生效。</li><li><code>author</code>：文章作者，未配置时取全局配置。</li><li><code>categories</code>：文章分类，仅支持单个。</li><li><code>tags</code>：文章标签，支持多个。</li></ul><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">---</span></span>
...
<span class="line"><span style="color:#24292E;">---</span></span></code></pre></div><p>为确保其他页跳转归档页(标签页,分类页)正常，需要配置 <code>归档页</code> 对应地址。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-x_92e" id="tab-uzceQDo" checked="checked"><label for="tab-uzceQDo">config.ts</label><input type="radio" name="group-x_92e" id="tab-8fzCrwy"><label for="tab-8fzCrwy">theme.d.ts</label></div><div class="blocks"><div class="language-ts vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#F97583;">export</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">defineConfig</span><span style="color:#E1E4E8;">({</span></span>
...
<span class="line"><span style="color:#22863A;">date</span><span style="color:#24292E;">: </span><span style="color:#005CC5;">2019-11-20 10:16:09</span></span>
<span class="line"><span style="color:#24292E;">---</span></span></code></pre></div><h2 id="友接页-links" tabindex="-1">友接页 Links <a class="header-anchor" href="#友接页-links" aria-label="Permalink to &quot;友接页 Links&quot;">​</a></h2><p>在 <code>layout</code> 为 <code>links</code> 时为友链页，页面会根据 <code>links</code> 配置渲染列表。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-5dwxR" id="tab-sYhHodR" checked="checked"><label for="tab-sYhHodR">link.md</label><input type="radio" name="group-5dwxR" id="tab-vFa8DvD"><label for="tab-vFa8DvD">links.ts</label><input type="radio" name="group-5dwxR" id="tab-rmY_9TY"><label for="tab-rmY_9TY">config.ts</label><input type="radio" name="group-5dwxR" id="tab-qUuk-82"><label for="tab-qUuk-82">theme.d.ts</label></div><div class="blocks"><div class="language-md vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">---</span></span>
...
<span class="line"><span style="color:#24292E;">	},</span></span>
<span class="line"><span style="color:#24292E;">});</span></span></code></pre></div><h2 id="关于页-about" tabindex="-1">关于页 About <a class="header-anchor" href="#关于页-about" aria-label="Permalink to &quot;关于页 About&quot;">​</a></h2><p>在 <code>layout</code> 为 <code>about</code> 时，根据配置生成页面。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-GUVlF" id="tab-wdY-djR" checked="checked"><label for="tab-wdY-djR">about.md</label><input type="radio" name="group-GUVlF" id="tab-RiNppVw"><label for="tab-RiNppVw">config.ts</label><input type="radio" name="group-GUVlF" id="tab-mTHEHpp"><label for="tab-mTHEHpp">theme.d.ts</label></div><div class="blocks"><div class="language-md vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">---</span></span>
...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div></div></div><h2 id="_404-not-found" tabindex="-1">404 Not Found <a class="header-anchor" href="#_404-not-found" aria-label="Permalink to &quot;404 Not Found&quot;">​</a></h2><p>404 页面不需要额外配置即生效，可在配置中替换 404 文案和跳转信息。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-jU2Cf" id="tab-SRhrPQV" checked="checked"><label for="tab-SRhrPQV">config.ts</label><input type="radio" name="group-jU2Cf" id="tab-c515cYy"><label for="tab-c515cYy">theme.d.ts</label></div><div class="blocks"><div class="language-ts vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#F97583;">export</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">defineConfig</span><span style="color:#E1E4E8;">({</span></span>
<span class="line"><span style="color:#E1E4E8;">	themeConfig: {</span></span>
