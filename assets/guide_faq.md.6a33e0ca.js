...
<span class="line"><span style="color:#24292E;">  },</span></span>
<span class="line"><span style="color:#24292E;">});</span></span></code></pre></div><h3 id="文件内容" tabindex="-1">文件内容 <a class="header-anchor" href="#文件内容" aria-label="Permalink to &quot;文件内容&quot;">​</a></h3><ul><li><p>如果原来文章里使用了 hexo tag，需要对其进行修改</p></li><li><p>文章里使用了 script、style 等语句块的需要对其 vitepress 里 <a href="https://vitepress.dev/zh/guide/using-vue#script-and-style" target="_blank" rel="noreferrer">&lt;script&gt; 和 &lt;style&gt;</a> 规则进行调整</p></li></ul><h3 id="评论迁移" tabindex="-1">评论迁移 <a class="header-anchor" href="#评论迁移" aria-label="Permalink to &quot;评论迁移&quot;">​</a></h3><p>主题目前没有内置其他评论插件，需要参考插件在 vitepress 使用方式</p><p><a href="https://github.com/twikoojs/twikoo/blob/main/docs/.vitepress/theme/Twikoo.vue" target="_blank" rel="noreferrer">twikoo</a> 在 vitepress 使用示例</p>`,37);function u(h,v,f,m,g,b){const n=p("Badge");return l(),o("div",null,[i,s("div",d,[y,s("ul",null,[s("li",null,[t(n,{text:"dev",vertical:"middle"}),a(" 代表只和开发有关。默认示例站点使用的 dev 分支，所以可能会出现还未发版功能。")])])]),E])}const k=e(r,[["render",u]]);export{F as __pageData,k as default};
