...
<span class="line"><span style="color:#24292E;">---</span></span></code></pre></div><p>为确保其他页跳转归档页(标签页,分类页)正常，需要配置 <code>归档页</code> 对应地址。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-IY6p9" id="tab-7R3EFso" checked="checked"><label for="tab-7R3EFso">config.ts</label><input type="radio" name="group-IY6p9" id="tab-Hwe4AC7"><label for="tab-Hwe4AC7">theme.d.ts</label></div><div class="blocks"><div class="language-ts vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#F97583;">export</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">defineConfig</span><span style="color:#E1E4E8;">({</span></span>
...
<span class="line"><span style="color:#22863A;">date</span><span style="color:#24292E;">: </span><span style="color:#005CC5;">2019-11-20 10:16:09</span></span>
<span class="line"><span style="color:#24292E;">---</span></span></code></pre></div><h2 id="友接页-links" tabindex="-1">友接页 Links <a class="header-anchor" href="#友接页-links" aria-label="Permalink to &quot;友接页 Links&quot;">​</a></h2><p>在 <code>layout</code> 为 <code>links</code> 时为友链页，页面会根据 <code>links</code> 配置渲染列表。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-rJMVo" id="tab-SLMKlFK" checked="checked"><label for="tab-SLMKlFK">link.md</label><input type="radio" name="group-rJMVo" id="tab-yCFNg9-"><label for="tab-yCFNg9-">links.ts</label><input type="radio" name="group-rJMVo" id="tab-nqajdOy"><label for="tab-nqajdOy">config.ts</label><input type="radio" name="group-rJMVo" id="tab-q73QjLg"><label for="tab-q73QjLg">theme.d.ts</label></div><div class="blocks"><div class="language-md vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">---</span></span>
...
<span class="line"><span style="color:#24292E;">	},</span></span>
<span class="line"><span style="color:#24292E;">});</span></span></code></pre></div><h2 id="关于页-about" tabindex="-1">关于页 About <a class="header-anchor" href="#关于页-about" aria-label="Permalink to &quot;关于页 About&quot;">​</a></h2><p>在 <code>layout</code> 为 <code>about</code> 时，根据配置生成页面。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-RQDSX" id="tab-O10s6-d" checked="checked"><label for="tab-O10s6-d">about.md</label><input type="radio" name="group-RQDSX" id="tab-oJNqyxQ"><label for="tab-oJNqyxQ">config.ts</label><input type="radio" name="group-RQDSX" id="tab--h8Irrw"><label for="tab--h8Irrw">theme.d.ts</label></div><div class="blocks"><div class="language-md vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">---</span></span>
...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div></div></div><h2 id="_404-not-found" tabindex="-1">404 Not Found <a class="header-anchor" href="#_404-not-found" aria-label="Permalink to &quot;404 Not Found&quot;">​</a></h2><p>404 页面不需要额外配置即生效，可在配置中替换 404 文案和跳转信息。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-2A5-r" id="tab-JpOvIR9" checked="checked"><label for="tab-JpOvIR9">config.ts</label><input type="radio" name="group-2A5-r" id="tab-jIMFe0G"><label for="tab-jIMFe0G">theme.d.ts</label></div><div class="blocks"><div class="language-ts vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#F97583;">export</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">defineConfig</span><span style="color:#E1E4E8;">({</span></span>
<span class="line"><span style="color:#E1E4E8;">	themeConfig: {</span></span>
