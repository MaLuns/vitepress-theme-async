...
<span class="line"><span style="color:#24292E;">---</span></span></code></pre></div><p>为确保其他页跳转归档页(标签页,分类页)正常，需要配置 <code>归档页</code> 对应地址。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-bSSld" id="tab-9UCytxB" checked="checked"><label for="tab-9UCytxB">config.ts</label><input type="radio" name="group-bSSld" id="tab-nSsUpE8"><label for="tab-nSsUpE8">theme.d.ts</label></div><div class="blocks"><div class="language-ts vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#F97583;">export</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">defineConfig</span><span style="color:#E1E4E8;">({</span></span>
...
<span class="line"><span style="color:#22863A;">date</span><span style="color:#24292E;">: </span><span style="color:#005CC5;">2019-11-20 10:16:09</span></span>
<span class="line"><span style="color:#24292E;">---</span></span></code></pre></div><h2 id="友接页-links" tabindex="-1">友接页 Links <a class="header-anchor" href="#友接页-links" aria-label="Permalink to &quot;友接页 Links&quot;">​</a></h2><p>在 <code>layout</code> 为 <code>links</code> 时为友链页，页面会根据 <code>links</code> 配置渲染列表。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-Pgnuk" id="tab-3hXHsWW" checked="checked"><label for="tab-3hXHsWW">link.md</label><input type="radio" name="group-Pgnuk" id="tab-5zCOI2u"><label for="tab-5zCOI2u">links.ts</label><input type="radio" name="group-Pgnuk" id="tab-NVbnEp0"><label for="tab-NVbnEp0">config.ts</label><input type="radio" name="group-Pgnuk" id="tab-m9PQq8s"><label for="tab-m9PQq8s">theme.d.ts</label></div><div class="blocks"><div class="language-md vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">---</span></span>
...
<span class="line"><span style="color:#24292E;">	},</span></span>
<span class="line"><span style="color:#24292E;">});</span></span></code></pre></div><h2 id="关于页-about" tabindex="-1">关于页 About <a class="header-anchor" href="#关于页-about" aria-label="Permalink to &quot;关于页 About&quot;">​</a></h2><p>在 <code>layout</code> 为 <code>about</code> 时，根据配置生成页面。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-UDNEg" id="tab--iaL6b3" checked="checked"><label for="tab--iaL6b3">about.md</label><input type="radio" name="group-UDNEg" id="tab-CRka19k"><label for="tab-CRka19k">config.ts</label><input type="radio" name="group-UDNEg" id="tab-OekZb7c"><label for="tab-OekZb7c">theme.d.ts</label></div><div class="blocks"><div class="language-md vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">---</span></span>
