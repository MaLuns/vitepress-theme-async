...
<span class="line"><span style="color:#24292E;">---</span></span></code></pre></div><p>为确保其他页跳转归档页(标签页,分类页)正常，需要配置 <code>归档页</code> 对应地址。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-UwFCR" id="tab-Fv_jc7-" checked="checked"><label for="tab-Fv_jc7-">config.ts</label><input type="radio" name="group-UwFCR" id="tab-fehJcQx"><label for="tab-fehJcQx">theme.d.ts</label></div><div class="blocks"><div class="language-ts vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#F97583;">export</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">defineConfig</span><span style="color:#E1E4E8;">({</span></span>
...
<span class="line"><span style="color:#22863A;">date</span><span style="color:#24292E;">: </span><span style="color:#005CC5;">2019-11-20 10:16:09</span></span>
<span class="line"><span style="color:#24292E;">---</span></span></code></pre></div><h2 id="友接页-links" tabindex="-1">友接页 Links <a class="header-anchor" href="#友接页-links" aria-label="Permalink to &quot;友接页 Links&quot;">​</a></h2><p>在 <code>layout</code> 为 <code>links</code> 时为友链页，页面会根据 <code>links</code> 配置渲染列表。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-e4VQw" id="tab-xVQNJcG" checked="checked"><label for="tab-xVQNJcG">link.md</label><input type="radio" name="group-e4VQw" id="tab-YvpJIop"><label for="tab-YvpJIop">links.ts</label><input type="radio" name="group-e4VQw" id="tab-2063TIe"><label for="tab-2063TIe">config.ts</label><input type="radio" name="group-e4VQw" id="tab-lPtt9It"><label for="tab-lPtt9It">theme.d.ts</label></div><div class="blocks"><div class="language-md vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">---</span></span>
...
<span class="line"><span style="color:#24292E;">	},</span></span>
<span class="line"><span style="color:#24292E;">});</span></span></code></pre></div><h2 id="关于页-about" tabindex="-1">关于页 About <a class="header-anchor" href="#关于页-about" aria-label="Permalink to &quot;关于页 About&quot;">​</a></h2><p>在 <code>layout</code> 为 <code>about</code> 时，根据配置生成页面。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-GeJcQ" id="tab-DiI-nSK" checked="checked"><label for="tab-DiI-nSK">about.md</label><input type="radio" name="group-GeJcQ" id="tab-Jj4L_W6"><label for="tab-Jj4L_W6">config.ts</label><input type="radio" name="group-GeJcQ" id="tab-fbFKios"><label for="tab-fbFKios">theme.d.ts</label></div><div class="blocks"><div class="language-md vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">---</span></span>
...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div></div></div><h2 id="_404-not-found" tabindex="-1">404 Not Found <a class="header-anchor" href="#_404-not-found" aria-label="Permalink to &quot;404 Not Found&quot;">​</a></h2><p>404 页面不需要额外配置即生效，可在配置中替换 404 文案和跳转信息。</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-lh1o-" id="tab-F02b9hD" checked="checked"><label for="tab-F02b9hD">config.ts</label><input type="radio" name="group-lh1o-" id="tab-pLsDQ1u"><label for="tab-pLsDQ1u">theme.d.ts</label></div><div class="blocks"><div class="language-ts vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#F97583;">export</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">defineConfig</span><span style="color:#E1E4E8;">({</span></span>
<span class="line"><span style="color:#E1E4E8;">	themeConfig: {</span></span>
